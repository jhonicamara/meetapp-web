...
Esta aplicação em React JS possibilita aos usuários criarem, editarem e cancelarem meetups e também permite a edição do perfil.


Veja também o **backend**, clique aqui: [MeetApp API](https://github.com/jhonicamara/meetapp-api)<br />
...
```bash
$ git clone https://github.com/jhonicamara/meetapp-web.git meetapp-web && cd meetapp-web
```
